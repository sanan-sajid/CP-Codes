...
int32_t main()
{
  ...
  while (t--)
  {
    ...
    {
      debug((a - idk[i].first) % x, idk[i].second);
      if (x == 0 && y == 0)
      {
        if (a == idk[i].first && b == idk[i].second)
          f = 1;
      }
      else if (x == 0)
      {
        if (a == idk[i].first && ((b - idk[i].second) % y == 0))
        {
          int k = (b - idk[i].second) / y;

          if (k * x + idk[i].first == a && k * y + idk[i].second == b && k >= 0)
          {
            f = 1;
          }
        }
      ...
      {
        if (((a - idk[i].first) % x == 0) && b == idk[i].second)
        {
          int k = (a - idk[i].first) / x;
      ...
      else if (((a - idk[i].first) % x == 0) && ((b - idk[i].second) % y == 0))
      {
        int k = (a - idk[i].first) / x;
        debug(k);
        if (k * x + idk[i].first == a && k * y + idk[i].second == b && k >= 0)
