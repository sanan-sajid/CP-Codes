...
bool f(vector<vector<int>> &v, int &x, int mid)
{
  int cost = 0;
  for (auto it : v)
  {
    ...
    {
      // use all a
      cost += ceil2(mid, it[0]) * it[1];
    }
    else
    {
      // use all b
      cost += ceil2(mid, it[2]) * it[3];
    }
    // if (it[0] * it[3] > it[1] * it[2])
    // {
    //   cost += ceil2(mid, it[2]) * it[3];
    // }
    // else if (it[0] * it[3] == it[1] * it[2])
    // {
    //   if ((it[0] % mid) >= (it[2] % mid))
    //     cost += ceil2(mid, it[2]) * it[3];
    //    else
    //    cost += ceil2(mid, it[0]) * it[1];
    // }
