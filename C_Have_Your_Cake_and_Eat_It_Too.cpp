...
vector<int> idk(6);
bool f(vector<int> &a, vector<int> &b, vector<int> &c, int need, int n)
{
  idk[0] = 0;
  int temp = 0;
  ...
  idk[5] = n - 1;
  // debug(temp, temp2, temp3, need);
  return ((temp >= need) && temp2 >= need && temp3 >= need);
}
int32_t main()
{
  ...
  while (t--)
  {
    ...
    else
    {
      ...
      else if (f(a, c, b, need, n))
      {
        cout << idk[0] + 1 << " " << idk[1] + 1 << " " << idk[4] + 1 << " " << idk[5] + 1 << " " << idk[2] + 1 << " " << idk[3] + 1;
      }
      else if (f(b, a, c, need, n))
      {

        cout << idk[2] + 1 << " " << idk[3] + 1 << " " << idk[0] + 1 << " " << idk[1] + 1 << " " << idk[4] + 1 << " " << idk[5] + 1;
      }
      else if (f(b, c, a, need, n))
      {

        cout << idk[4] + 1 << " " << idk[5] + 1 << " " << idk[0] + 1 << " " << idk[1] + 1 << " " << idk[2] + 1 << " " << idk[3] + 1;
      }
      else if (f(c, a, b, need, n))
      {

        cout << idk[2] + 1 << " " << idk[3] + 1 << " " << idk[4] + 1 << " " << idk[5] + 1 << " " << idk[0] + 1 << " " << idk[1] + 1;
      }
      else if (f(c, b, a, need, n))
      {
        cout << idk[4] + 1 << " " << idk[5] + 1 << " " << idk[2] + 1 << " " << idk[3] + 1 << " " << idk[0] + 1 << " " << idk[1] + 1;
      }
    }
    cout << '\n';
  }
