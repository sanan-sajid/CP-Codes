...
int32_t main()
{
  ...
  while (t--)
  {
    ...
    {
      int temp = modPower(2, l);
      modmul(temp, (((modPower(2, r - l)) - 1)), m);
      cout << temp % m;
    }
    else if (k == 5)
    {
    ...
    {
      // 0,1,2
      int temp = modPower(3, l);
      // debug(temp);

      modmul(temp, (((modPower(3, r - l)) - 1)), m);
      cout << temp % m;
    }
    else if (k == 3)
    {
      // 0,1,2,3
      int temp = modPower(4, l);
      modmul(temp, (((modPower(4, r - l)) - 1)), m);
      cout << temp % m;
    }
    else if (k == 2)
    { // 0,1,2,3,4
      int temp = modPower(5, l);
      modmul(temp, (((modPower(5, r - l)) - 1)), m);
      cout << temp % m;
    }
    else
    {
      cout << (modPower(10, r) - modPower(10, l) + m) % m;
      // k==1
    }
    cout << '\n';
  }
