...
int32_t main()
{
  ...
  while (t--)
  {
    ...
    int CntAa = count(all(a), 'a');
    int CntAb = count(all(a), 'b');
    int CntAc = count(all(a), 'c');
    int CntBa = count(all(b), 'a');
    int CntBb = count(all(b), 'b');
    int CntBc = count(all(b), 'c');
    bool f = 1;
    if ((CntAa != CntBa) || (CntAb != CntBb) || (CntAc != CntBc))
    {
      f = 0;
    }
    for (int i = 0; i < n; i++)
    ...
    {
      if (idk1[i] == idk2[i] && idk1[i] == 0)
      {
        continue;
      }
      else if (extra < idk2[i])
      {
        f = 0;
        break;
      }
      ...
      // if (idk1[i] == idk2[i])
      //   continue;
      // else if (idk1[i] < idk2[i])
      // {
      //   if (idk1[i] + extra < idk2[i])
      //   {
      //     f = 0;
      //     break;
      //   }
